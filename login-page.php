...
function my_login_head2() {
	...
	body.login #login h1 a {
		background: url('".plugin_dir_url( __FILE__ )."images/innermedia-logo-small.png') no-repeat scroll center top transparent;
	...
	@media (-webkit-min-device-pixel-ratio: 2), (min-resolution: 192dpi) {
		body.login #login h1 a {
			background: url('".plugin_dir_url( __FILE__ )."images/innermedia-logo-retina.png') no-repeat scroll center top transparent;
   			background-size: 255px 88px;
		}
	}

	body.login {
		background: url('".plugin_dir_url( __FILE__ )."images/login-bg-large.png') no-repeat center top;
		text-align: center;
	}
